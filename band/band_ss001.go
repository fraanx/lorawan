	...
	b := ss001Band{
		band: band{
			...
			dataRates: map[int]DataRate{
				0:  {Modulation: XssModulation, SpreadFactor: 64, Bandwidth: 240, uplink: true, downlink: false},
				1:  {Modulation: XssModulation, SpreadFactor: 128, Bandwidth: 240, uplink: true, downlink: false},
				2:  {Modulation: XssModulation, SpreadFactor: 255, Bandwidth: 240, uplink: true, downlink: false},
				3:  {Modulation: XssModulation, SpreadFactor: 64, Bandwidth: 240, uplink: true, downlink: false},
				4:  {Modulation: XssModulation, SpreadFactor: 128, Bandwidth: 240, uplink: true, downlink: false},
				5:  {Modulation: XssModulation, SpreadFactor: 255, Bandwidth: 240, uplink: true, downlink: false},
				11:  {Modulation: XssModulation, SpreadFactor: 16, Bandwidth: 2400, uplink: false, downlink: true},
			},
